...
init_path = os.path.join('kore_plugins_beaker', '__init__.py')
...
entry_points = """\
[kore.components]
kore.components.beaker = kore_plugins_beaker.plugins.base:BeakerPlugin
kore.components.beaker.cache =\
    kore_plugins_beaker.plugins.cache:BeakerCachePlugin
"""


setup(
    name='kore-plugins-beaker',
    version=metadata['version'],
    author=metadata['author'],
    author_email=metadata['email'],
    url=metadata['url'],
    packages=find_packages(include=('kore_plugins_beaker*',)),
